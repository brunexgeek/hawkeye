...
float PhysicsRigidBody::getFriction() const
{
    GP_ASSERT(_body);
...
float PhysicsRigidBody::getLinearDamping() const
{
    GP_ASSERT(_body);
    return _body->getLinearDamping();
}

float PhysicsRigidBody::getAngularDamping() const
{
    GP_ASSERT(_body);
...
Vector3 PhysicsRigidBody::getLinearVelocity() const
{
    GP_ASSERT(_body);
...
void PhysicsRigidBody::setLinearVelocity(float x, float y, float z)
{
    GP_ASSERT(_body);
    _body->setLinearVelocity(btVector3(x, y, z));
}

Vector3 PhysicsRigidBody::getAngularVelocity() const
{
    GP_ASSERT(_body);
...
void PhysicsRigidBody::setAngularVelocity(float x, float y, float z)
{
    GP_ASSERT(_body);
    _body->setAngularVelocity(btVector3(x, y, z));
}

Vector3 PhysicsRigidBody::getAnisotropicFriction() const
{
    GP_ASSERT(_body);
...
void PhysicsRigidBody::setAnisotropicFriction(float x, float y, float z)
{
    GP_ASSERT(_body);
    _body->setAnisotropicFriction(btVector3(x, y, z));
}

Vector3 PhysicsRigidBody::getGravity() const
{
    GP_ASSERT(_body);
...
void PhysicsRigidBody::setGravity(float x, float y, float z)
{
    GP_ASSERT(_body);
    _body->setGravity(btVector3(x, y, z));
}

Vector3 PhysicsRigidBody::getAngularFactor() const
{
    GP_ASSERT(_body);
...
void PhysicsRigidBody::setAngularFactor(const Vector3& angularFactor)
{
    GP_ASSERT(_body);
    _body->setAngularFactor(BV(angularFactor));
}

void PhysicsRigidBody::setAngularFactor(float x, float y, float z)
{
    GP_ASSERT(_body);
    _body->setAngularFactor(btVector3(x, y, z));
}

Vector3 PhysicsRigidBody::getLinearFactor() const
{
    GP_ASSERT(_body);
...
void PhysicsRigidBody::setLinearFactor(const Vector3& angularFactor)
{
    GP_ASSERT(_body);
    _body->setLinearFactor(BV(angularFactor));
}

void PhysicsRigidBody::setLinearFactor(float x, float y, float z)
{
    GP_ASSERT(_body);
    _body->setLinearFactor(btVector3(x, y, z));
}

bool PhysicsRigidBody::isStatic() const
{
    GP_ASSERT(_body);
