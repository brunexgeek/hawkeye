...
const Rectangle& Game::getViewport() const
{
    return _viewport;
}

AnimationController* Game::getAnimationController() const
{
    return _animationController;
}

AudioController* Game::getAudioController() const
{
    return _audioController;
}

PhysicsController* Game::getPhysicsController() const
{
    return _physicsController;
}

ScriptController* Game::getScriptController() const
{
    return _scriptController;
}
AIController* Game::getAIController() const
{
...
void Game::setMultiSampling(bool enabled)
{
    Platform::setMultiSampling(enabled);
}

bool Game::isMultiSampling() const
{
    return Platform::isMultiSampling();
}

void Game::setMultiTouch(bool enabled)
{
    Platform::setMultiTouch(enabled);
}

bool Game::isMultiTouch() const
{
    return Platform::isMultiTouch();
}

bool Game::canExit() const
{
    return Platform::canExit();
}

bool Game::hasAccelerometer() const
{
	return Platform::hasAccelerometer();
}

void Game::getAccelerometerValues(float* pitch, float* roll)
{
    Platform::getAccelerometerValues(pitch, roll);
}

void Game::getSensorValues(float* accelX, float* accelY, float* accelZ, float* gyroX, float* gyroY, float* gyroZ)
{
    return Platform::getSensorValues(accelX, accelY, accelZ, gyroX, gyroY, gyroZ);
}

unsigned int Game::getGamepadCount() const
{
    return Gamepad::getGamepadCount();
}

Gamepad* Game::getGamepad(unsigned int index, bool preferPhysical) const
{
    return Gamepad::getGamepad(index, preferPhysical);
}

void Game::displayKeyboard(bool display)
{
    Platform::displayKeyboard(display);
}

bool Game::launchURL(const char* url) const
{
